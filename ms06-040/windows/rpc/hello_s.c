...
/* Standard interface: HelloWorld, ver. 1.0,
   GUID={0x62560D0C,0xC276,0x45cd,{0xB6,0x0C,0x29,0x22,0xBE,0x90,0x03,0x1B}} */


extern const MIDL_SERVER_INFO HelloWorld_ServerInfo;

extern RPC_DISPATCH_TABLE HelloWorld_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE HelloWorld___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x62560D0C,0xC276,0x45cd,{0xB6,0x0C,0x29,0x22,0xBE,0x90,0x03,0x1B}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    &HelloWorld_v1_0_DispatchTable,
    0,
    0,
    0,
...
static RPC_DISPATCH_FUNCTION HelloWorld_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
